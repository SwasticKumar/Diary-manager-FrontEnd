...
const MyCalendar = () => {
  ...
  return (
    <div className="App bg-grey">
      <h1 className='text-3xl text-center mb-4 font-bold'>Event Manager</h1>
      <div className="grid grid-cols-3 gap-3">

        {/* Event Form */}
        <div className="col-span-3 sm:col-span-1 pl-3">
          <EventForm />
        </div>
        ...
        <div className="col-span-3 sm:col-span-1">
          {events.length > 0 &&
            <div className="bg-orange p-4 rounded shadow-md">
