...
export default function UsersContextProvider({ children }) {
    ...
    useEffect(() => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/users/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    const handleSignup = (event) => {
        ...
        const SIGNUP_URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/signup/createUser`;
    ...
    const handleLogin = (event) => {
        ...
        const LOGIN_URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/login`;
    ...
    const handleMail = (event) => {
        ...
        setLoaded("true");
        const FORGOT_URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/forgot`;
    ...
    const handleLogout = async (event) => {
        ...
        const LOGOUT_URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/login/logout`;
    ...
    const handleUpdateUser = (event) => {
        event.preventDefault();
        setUser({ ...user, ...input })
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/updateUser/${signinUser}`;
    ...
    useEffect(() => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    const addEvent = (newEvent) => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/add/${signinUser}`;
    ...
    const handleCalendarDelete = (event) => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/delete/${signinUser}/${event.title}`;
        axios.delete(URL)
            .then(res => {
    ...
    const handleCalendarSaveEdit = (editedEvent) => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/calendarEvent/edit/${signinUser}/${editEvent.title}`;
    ...
    useEffect(() => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    function handleTodo(event) {
        ...
        const URL =  `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/add/${signinUser}`;
        axios.post(URL, todo)
            .then(res => {
                setTodo({});
            })
    ...
    function handleUpdateTodo(event) {
        ...
        if (mode === "edit") {
            ...
            setMode("create");
            setTodo({});
            const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/edit/${signinUser}/${todo.title}`;
    ...
    function handleDeleteTodo(title = "") {
        ...
        setTodos(matchedData);
        const URL =`${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/todo/delete/${signinUser}/${title}`;
        axios.delete(URL)
            .then(res => {
    ...
    useEffect(() => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/${signinUser}`;
        axios.get(URL)
            .then(res => {
    ...
    const addContact = (newContact) => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/add/${signinUser}`;
    ...
    const handleContactsDelete = (contact) => {
        const URL = `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/delete/${signinUser}/${contact.name}`;
        axios.delete(URL)
            .then(res => {
    ...
    const handleContactsSaveEdit = (editedContact) => {
        const URL =  `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/contacts/edit/${signinUser}/${editedContact.name}`;
    ...
    useEffect(() => {
        const URL =  `${process.env.REACT_APP_PRO_URL_FOR_BACKEND}/festival/get`;
        axios.get(URL)
            .then(res => {
